...
use App\Notifications\Hr\LeaveAccrualNotification;
...
$trans = LeaveAccrualHelpers::postLeaveAccruals($asOfDate, $transDate);

if ($trans) {
    $notification = new LeaveAccrualNotification([
    ...
    $group = EntityGroup::find(EntityGroup::LEAVE_ACCRUAL_NOTIFICATION);
