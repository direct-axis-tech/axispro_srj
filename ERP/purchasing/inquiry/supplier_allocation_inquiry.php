...
page(trans($help_context = "Supplier Allocation Inquiry"), false, false, "", $js);
...
supplier_list_cells(trans("Select a supplier: "), 'supplier_id', $_POST['supplier_id'], true);
...
$cols = array(
	...
	trans("Ref #") => array('fun'=>'view_link', 'ord'=>'', 'align'=>'right'),
	trans("Reference") => 'skip',
	trans("Supplier") => array('ord'=>''), 
	trans("Supp Reference"),
