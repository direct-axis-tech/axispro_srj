...
page(trans($help_context = "View Supplier Invoice"), true, false, "", $js);
...
display_heading(trans("SUPPLIER INVOICE") . " # " . $trans_no);
echo "<br>";
...
if (!is_company_currency($supplier_curr_code))
	label_cells(trans("Currency"), $supplier_curr_code, "class='tableheader2'");
end_row();
...
start_table(TABLESTYLE, "width='95%'");
label_row(trans("Sub Total"), $display_sub_tot, "align=right", "nowrap align=right width='15%'");
...
label_row(trans("TOTAL INVOICE").' ('.$supplier_curr_code.')', $display_total, "colspan=1 align=right", "nowrap align=right");

end_table(1);

$voided = is_voided_display(ST_SUPPINVOICE, $trans_no, trans("This invoice has been voided."));
