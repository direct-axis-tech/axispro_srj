...
page(trans($help_context = "View Dimension"), true, false, "", $js);
...
if ($myrow == false)
{
	echo trans("The dimension number sent is not valid.");
    exit;
}

start_table(TABLESTYLE);

$th = array(trans("#"), trans("Reference"), trans("Name"), trans("Type"), trans("Date"), trans("Due Date"));
table_header($th);
...
{
	display_note(trans("This dimension is closed."));
}
...
submit_cells('Show',trans("Show"), '', false, 'default');
