...
page(trans($help_context = "GL Accounts"), true, false, "", $js);
...
text_cells(trans("Description"), "description");
submit_cells("search", trans("Search"), "", trans("Search GL accounts"), "default");
...
$th = array("", trans("Account Code"), trans("Description"), trans("Category"));
