...
function defaultCompany()
{
	...
	$title = $app_title." ".$version." - ".trans("Password reset");
  ...
  echo "<a target='_blank' href='$power_url'><img src='$path_to_root/themes/$def_theme/images/logo_frontaccounting.png' alt='FrontAccounting' height='50' onload='fixPNG(this)' border='0' ></a>";
	...
	table_section_title(trans("Version")." $version   Build $build_version - ".trans("Password reset"));
...
//			$coy = $def_coy;
  ...
  end_row();
	...
	echo "<tr>\n";
	echo "<td><a target='_blank' href='$power_url' tabindex='-1'>$app_title $version - " . trans("Theme:") . " " . $def_theme . "</a></td>\n";
	echo "</tr>\n";
	echo "<tr>\n";
