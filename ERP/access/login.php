...
***********************************************************************/
	...
	include_once($path_to_root . "/themes/daxis/login.php");
...
function defaultCompany()
{
	...
	{
		$demo_text = trans("Please login here");
	...
	if (!$login_timeout) { // FA logo
		...
		echo "<font size=5>".trans('Authorization timeout')."</font>";
	} 
	echo "</td>\n";
	end_row();
	...
	text_row(trans("User name"), "user_name_entry_field", $value, 20, 30);

	$password = $SysPrefs->allow_demo_mode ? "password":"";

	password_row(trans("Password:"), 'password', $password);
	...
	echo "<center><input type='submit' value='&nbsp;&nbsp;".trans("Login -->")."&nbsp;&nbsp;' name='SubmitUser'"
