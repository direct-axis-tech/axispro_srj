...
function print_inventory_planning()
{
	...
	$headers = array(trans('Category'), '', $per4, $per3, $per2, $per1, $per0, '3*M',
		trans('QOH'), trans('Cust Ord'), trans('Supp Ord'), trans('Sugg Ord'));
    ...
    $rep = new FrontReport(trans('Inventory Planning Report'), "InventoryPlanning", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
