...
function inventory_movements()
{
	...
	$headers = array(trans('Category'), trans('Description'),	trans('UOM'),	trans('Opening'), trans('Quantity In'), trans('Quantity Out'), trans('Balance'));
    ...
    $rep = new FrontReport(trans('Inventory Movements'), "InventoryMovements", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
