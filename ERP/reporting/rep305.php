...
function print_grn_valuation()
{
	...
	$headers = array(trans('Stock ID'), trans('Description'), trans('PO No'), trans('GRN')."#", trans('Inv')."#", trans('Qty'), trans('Inv Price'), trans('PO Price'), trans('Total'));
    ...
    $rep = new FrontReport(trans('GRN Valuation Report'), "GRNValuationReport", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
