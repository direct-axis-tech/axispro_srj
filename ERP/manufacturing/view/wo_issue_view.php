...
page(trans($help_context = "View Work Order Issue"), true, false, "", $js);
...
function display_wo_issue($issue_no)
{
    ...
    $th = array(trans("Issue #"), trans("Reference"), trans("For Work Order #"),
    	trans("Item"), trans("From Location"), trans("To Work Centre"), trans("Date of Issue"));
    table_header($th);
	...
	is_voided_display(ST_MANUISSUE, $issue_no, trans("This issue has been voided."));
}
...
function display_wo_issue_details($issue_no)
{
    ...
    {
    	display_note(trans("There are no items for this issue."));
    }
    else
    {
        start_table(TABLESTYLE);
        $th = array(trans("Component"), trans("Quantity"), trans("Units"), trans("Unit Cost"));
...
display_heading2(trans("Items for this Issue"));
