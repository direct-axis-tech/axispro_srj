...
class TaskInitializedNotification extends Notification implements ShouldQueue, ShouldBroadcast
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        ...
        $employee = User::find($taskRecord->initiated_by);
        $data =  [
            'employee' => $employee->name,
            'title'    => 'New '.$taskRecord->task_type_name,
