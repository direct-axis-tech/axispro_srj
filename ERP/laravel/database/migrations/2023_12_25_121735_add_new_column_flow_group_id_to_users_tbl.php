...
class AddNewColumnFlowGroupIdToUsersTbl extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('0_users', function (Blueprint $table) {
            $table->bigInteger('flow_group_id')->nullable()->after('role_id');
        });
        ...
        DB::table('0_users')
            ...
            ->update([
                '0_users.flow_group_id' => DB::raw('0_emp_jobs.flow_group_id')
            ]);
    }
