...
var KTApp = function () {
    ...
    var initBsDatepicker = function () {
        ...
        var elements = [].slice.call(document.querySelectorAll('[data-control="bsDatepicker"], [data-kt-bs-datepicker="true"]'));

        elements.map(function (element) {
            var options = {
                format: document.querySelector('meta[name="bs-date-format"]')?.content || null,
                orientation: 'bottom',
                todayHighlight: true,
                autoclose: true,
