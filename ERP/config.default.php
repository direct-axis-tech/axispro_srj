...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	$UTF8_fontfile	= "FreeSans.ttf"; // for Arabic Dashboard
...
/*
	Option To Switch Sales Invoice Discount Applied To Taxable Or Tax Included Amount
*/
	$sales_invoice_discount_apply_on_taxable_amount = true; 