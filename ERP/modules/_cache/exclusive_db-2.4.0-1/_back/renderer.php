	...
	class renderer
	{
		...
		function menu_header($title, $no_menu, $is_index)
		{
			...
			if (!$no_menu)
			{
				...
				$img = "<img src='$local_path_to_root/themes/exclusive_db/images/login.gif' width='14' height='14' border='0' alt='".trans('Logout')."'>&nbsp;&nbsp;";
				$himg = "<img src='$local_path_to_root/themes/exclusive_db/images/help.gif' width='14' height='14' border='0' alt='".trans('Help')."'>&nbsp;&nbsp;";
				echo "<div id='header'>\n";
				echo "<ul>\n";
