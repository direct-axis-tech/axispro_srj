            ...
            <div class="kt-container  kt-grid__item kt-grid__item--fluid">
                ...
                <div class="kt-portlet ">
                    ...
                    <div class="kt-portlet__body" style="padding: 25px !important;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        <button type="button" class="btn btn-success"
                                                onclick="LoadBalanceSheetDrillDownReport();"><?= trans('GET REPORT') ?>
                                        </button>
                                    </div>
                        ...
                        <!--begin::Accordion-->
                        <div class="accordion accordion-light accordion-svg-icon" id="AccordBalanceSheet">
...
<script>
    ...
    $(document).ready(function (e) {
        LoadBalanceSheetDrillDownReport();
    });
    ...
    function LoadBalanceSheetDrillDownReport() {

        BlockDiv("#AccordBalanceSheet");
        ...
        AxisPro.APICall('GET', route('API_Call', {method: 'get_class_balances'}), params, function (data) {
            ...
            $.each(data, function (key, value) {
                ...
                accord_html += '<div style="" class="card"><div class="card-header coa-card-header" ' +
                    'onclick="ExpandBalanceSheetAccordion(this)">';
               ...
               <div class="card-title collapsed" data-card-type="${value.coa_type}" data-bs-toggle="collapse"
                ...
                net_balance += parseFloat(value.amount);

            });


            var display_net_balance = amount(net_balance * -1);
            //Printing Calculated Return
            accord_html += '<div style="" class="card"><div class="card-header coa-card-header">';
            accord_html += `
               <div class="card-title collapsed"  data-bs-toggle="collapse" aria-expanded="false">
                ${accord_svg_icon['profit_loss']} <b>NET BALANCE :    &emsp;    ${display_net_balance} </b> </div></div>
                <div  class="collapse"  >
                <div class="card-body" >No Data</div></div>
                </div>`;

            $("#AccordBalanceSheet").html(accord_html);
    ...
    function ExpandBalanceSheetAccordion($this) {
        ...
        GenerateBSAccordionData(params, this_type, parent_id);

    }


    function GenerateBSAccordionData(params, this_type, parent_id, start) {
    ...
    function PaginateGLTransTable($this) {
        ...
        if ($($this).scrollTop() + $($this).innerHeight() >= $($this)[0].scrollHeight) {
            ...
            GenerateBSAccordionData(params, this_type, parent_id, start)
